  ...
  return (
    <div>
      ...
      <div className="current-skill-details" style={{
        ...
        <Tooltip title={"Used Daily"} placement="top">
          <Button style={{ background: theme.accent4, color: theme.accent5 }} variant="contained" href={"https://visualstudio.microsoft.com/"} target="_blank">{"Visual Studio"}</Button>
        </Tooltip>
      ...
      <div className="current-skill-details" style={{
        ...
        <Tooltip title={"Used Daily"} placement="top">
          <Button style={{ background: theme.accent4, color: theme.accent5 }} variant="contained" href={"https://www.ibm.com/garage/method/practices/code/practice_test_driven_development/"} target="_blank">{"Test-Driven Development"}</Button>
        </Tooltip>
      ...
      <div className="current-skill-details" style={{
        ...
        <Tooltip title={"Used Daily"} placement="top">
          <Button style={{ background: theme.accent4, color: theme.accent5 }} variant="contained" href={"https://docs.flightsimulator.com/html/Programming_Tools/SimConnect/SimConnect_SDK.htm"} target="_blank">{"SimConnect"}</Button>
        </Tooltip>
      ...
      <div className="current-skill-details" style={{
        ...
        <Tooltip title={"Used Daily"} placement="top">
          <Button style={{ background: theme.accent4, color: theme.accent5 }} variant="contained" href={"https://www.w3schools.com/"} target="_blank">{"HTML, CSS, Typescript, Javascript"}</Button>
        </Tooltip>
      ...
      <div className="current-skill-details" style={{
        ...
        <Tooltip title={"Used Daily"} placement="top">
          <Button style={{ background: theme.accent4, color: theme.accent5 }} variant="contained" href={"https://azure.microsoft.com/en-us/products/devops/"} target="_blank">{"Azure Dev Ops"}</Button>
        </Tooltip>
      ...
      <div className="current-skill-details" style={{
        ...
        <Tooltip title={"Used Frequently"} placement="top">
          <Button style={{ background: theme.accent4, color: theme.accent5 }} variant="contained" href={"https://www.sqltutorial.org/"} target="_blank">{"SQL"}</Button>
        </Tooltip>
      ...
      <div className="current-skill-details" style={{
        ...
        <Tooltip title={"Used Frequently"} placement="top">
          <Button style={{ background: theme.accent4, color: theme.accent5 }} variant="contained" href={"https://www.postman.com/"} target="_blank">{"Postman"}</Button>
        </Tooltip>
      ...
      <div className="current-skill-details" style={{
        ...
        <Tooltip title={"Used Ocassionally"} placement="top">
          <Button style={{ background: theme.accent4, color: theme.accent5 }} variant="contained" href={"https://www.virtualbox.org/"} target="_blank">{"Virtual Box"}</Button>
        </Tooltip>
      ...
      <div className="current-skill-details" style={{
        ...
        <Tooltip title={"Used Ocassionally"} placement="top">
          <Button style={{ background: theme.accent4, color: theme.accent5 }} variant="contained" href={"https://spring.io/guides"} target="_blank">{"Spring Framework"}</Button>
        </Tooltip>
      ...
      <div className="current-skill-details" style={{
        ...
        <Tooltip title={"Used Ocassionally"} placement="top">
          <Button style={{ background: theme.accent4, color: theme.accent5 }} variant="contained" href={"https://junit.org/"} target="_blank">{"JUnit"}</Button>
        </Tooltip>
      ...
      <div className="current-skill-details" style={{
        ...
        <Tooltip title={"Used Occasionally"} placement="top">
          <Button style={{ background: theme.accent4, color: theme.accent5 }} variant="contained" href={"https://aws.amazon.com/"} target="_blank">{"AWS"}</Button>
        </Tooltip>
      ...
      <div className="current-skill-details" style={{
        ...
        <Tooltip title={"Used Occasionally"} placement="top">
          <Button style={{ background: theme.accent4, color: theme.accent5 }} variant="contained" href={"https://www.jetbrains.com/idea/"} target="_blank">{"IntelliJ"}</Button>
        </Tooltip>
      ...
      <div className="current-skill-details" style={{
        ...
        <Tooltip title={"Used Rarely"} placement="top">
          <Button style={{ background: theme.accent4, color: theme.accent5 }} variant="contained" href={"https://www.thymeleaf.org/"} target="_blank">{"Thymeleaf"}</Button>
        </Tooltip>
      ...
      <div className="current-skill-details" style={{
        ...
        <Tooltip title={"Used Rarely"} placement="top">
          <Button style={{ background: theme.accent4, color: theme.accent5 }} variant="contained" href={"https://www.oracle.com/database/sqldeveloper/"} target="_blank">{"Oracle SQL Developer"}</Button>
        </Tooltip>
      ...
      <div className="current-skill-details" style={{
        ...
        <Tooltip title={"Used Rarely"} placement="top">
          <Button style={{ background: theme.accent4, color: theme.accent5 }} variant="contained" href={"https://www.linux.org/pages/download/"} target="_blank">{"Linux"}</Button>
        </Tooltip>
      ...
      <div className="current-skill-details" style={{
        ...
        <Tooltip title={"Used Rarely"} placement="top">
          <Button style={{ background: theme.accent4, color: theme.accent5 }} variant="contained" href={"https://kotlinlang.org/"} target="_blank">{"Kotlin"}</Button>
        </Tooltip>
