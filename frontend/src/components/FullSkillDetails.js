      ...
      <div className="current-skill-details" style={{ 
        ...
        transition: 'background 0.3s ease, color 0.3s ease'
          ...
          <Tooltip title={"Used Daily"} placement="top">
            <Button variant="contained" href={"https://visualstudio.microsoft.com/"} target="_blank">{"Visual Studio"}</Button>
          </Tooltip>
      ...
      <div className="current-skill-details" style={{ 
        ...
        transition: 'background 0.3s ease, color 0.3s ease'
          ...
          <Tooltip title={"Used Ocassionally"} placement="top">
            <Button variant="contained" href={"https://www.virtualbox.org/"} target="_blank">{"Virtual Box"}</Button>
          </Tooltip>
